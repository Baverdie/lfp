			...
			<div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-16">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
					...
					>
						...
						<nav className="flex flex-col gap-3">
							<a
								href="#hero"
								className="text-gray-400 hover:text-lfp-green transition-colors duration-300 text-sm"
									>
								Accueil
							</a>
							<a
					...
					>
						...
						<a
							...
							className="inline-flex items-center gap-3 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-600 hover:to-pink-600 text-white py-3 px-6 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-pink-500/50 font-semibold text-sm"
											>
				...
				< div className = "border-t border-lfp-green/20 pt-4" >
					<div className="flex flex-col md:flex-row justify-between items-center gap-4">
						...
						>
							Développé par{' '}
									<a href="https://baverdie.dev" target="_blank" rel="noopener noreferrer" className="text-lfp-green font-semibold hover:underline">
										Baverdie
									</a>
						</motion.p>
					</div>
