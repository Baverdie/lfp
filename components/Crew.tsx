		...
		>
			<div className='relative h-full w-full'>
				...
				<motion.div
					...
					className="relative w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-linear-to-b from-[#141414] to-[#0a0a0a] rounded-2xl"
				>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								{member.cars.map((car, index) => (
									<motion.div
										...
										className="relative bg-linear-to-b from-[#1a1a1a] to-[#0a0a0a] rounded-xl overflow-hidden border border-white/10 group hover:border-lfp-green/50 transition-all duration-500"
									>
										{/* Photo voiture */}
